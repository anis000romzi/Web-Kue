...
<?php
session_start();
$_SESSION['nama'] = "BLACK FOREST";
$_SESSION['harga'] = 60000;
?>
  ...
  <div class="container">
    ...
    <div class="main">
      ...
      <form action="../../php/konfirmasi.php" method="POST">
        ...
        <input id="alamat" name="alamat" size="50" placeholder="Jalan, RT/RW, Kode Pos, Kelurahan-Kecamatan" required /><br /><br />
        <label for="catatan">Catatan Tambahan :</label><br />
        <textarea id="catatan" rows="3" name="note"></textarea><br />
        <button type="submit" class="btn" value="Beli" />Beli
        <button type="button" class="btn btn-danger" onclick="history.back();" value="Kembali">
          Kembali
        </button>
      </form>
    </div>
